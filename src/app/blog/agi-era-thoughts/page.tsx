...
const content = {
  zh: {
    // ── 开场 ──
    h2_opening: "你有没有想过——",
    opening_p1: `如果有一天，任何知识、任何技能、任何产出都能被 AI 即时生成——<strong>「你会做什么」这件事就不再重要了。</strong>`,
    opening_p2: `这是 2026 年 7 月 31 日深夜，我和 Codex 聊天时碰到的问题。`,
    opening_p3: `我问的不是「AGI 什么时候来」那种技术预测，是更让人睡不着的东西：<strong>当一切都能被 AI 做掉，人还剩什么？</strong>`,
    opening_p4: `Codex 给了一个很漂亮的框架——「人类第一次从能力匮乏走进愿望匮乏。」`,
    opening_p5: `我觉得有道理。但隐约觉得哪里不对。`,
    opening_p6: `于是把整段对话贴给了 Claude Code，让它逐条质疑。它没复读——从几个我完全没想到的角度撕开了这个框架。然后我们顺着往下挖，挖出了一堆我从未认真想过的东西。`,
    opening_p7: `这篇文章就是那场对话的记录。<strong>不是「AI 写的 AGI 预测」——是一个大一学生，和两个 AI 一起，试图搞明白在这个一切都会被重做的时代里，人到底是什么。</strong>`,
  ...
  en: {
    ...
    opening_p2: `Late night, July 31, 2026. I was chatting with Codex when this question hit me.`,
    opening_p3: `Not the "when will AGI arrive" kind of prediction. Something more unsettling: <strong>when AI can do everything, what's left for humans?</strong>`,
    ...
    opening_p5: `It made sense. But something felt off.`,
    opening_p6: `So I pasted the whole conversation into Claude Code and asked it to critique, point by point. It didn't echo — it tore the framework open from angles I'd never considered. Then we dug deeper.`,
    opening_p7: `This article is that conversation. <strong>Not an "AI-generated AGI prediction" — it's a freshman, with two AIs, trying to figure out what a human being is when everything can be remade.</strong>`,
