...
const translations = {
  zh: {
    ...
    projects: [
      ...
      {
        title: "VAE 灰度数字生成",
        desc: "基于 PyTorch 的变分自编码器实现，在 MNIST 数据集上完成手写数字的重建与生成，附带完整的数学推导与训练过程记录。",
        tag: "深度学习",
        icon: "vae-bw",
      ...
      {
        title: "VAE 彩色图像与优化",
        desc: "在灰度 VAE 基础上扩展至 3 通道 RGB，实验按类染色、BCE 损失、β-VAE、KL 预热等优化策略，记录 4 次实验的完整数据。",
        tag: "深度学习",
        icon: "vae-color",
  ...
  en: {
    ...
    projects: [
      ...
      },
      {
        ...
        desc: "A PyTorch implementation of Variational Autoencoder for MNIST digit reconstruction and generation, with complete mathematical derivations and training logs.",
        tag: "Deep Learning",
        icon: "vae-bw",
        link: "/blog/vae-1-introduction",
      },
      {
        ...
        desc: "Extending the grayscale VAE to 3-channel RGB, experimenting with per-class coloring, BCE loss, β-VAE, and KL warm-up. Includes data from 4 complete experiments.",
        tag: "Deep Learning",
        icon: "vae-color",
        link: "/blog/vae-2-color",
      },
